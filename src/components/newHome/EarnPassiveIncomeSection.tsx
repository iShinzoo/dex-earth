...
const EarnPassiveIncomeSection = () => (
  <section className="md:py-[56px] py-[25px] px-4 text-center">
    <h2 className="max-w-[663px] mx-auto font-medium md:text-7xl text-[39px] md:leading-[79.2px] tracking-[-2.88px] text-center text-[#3DBEA3] md:mb-[33px] mb-[20px]">
    ...
    <h4 className="font-medium md:text-[17.6px] text-sm md:leading-[31.68px] md:tracking-[-0.53px] text-center text-[#3DBEA3] md:mt-[42px] mt-[15px] mb-[30px]">
