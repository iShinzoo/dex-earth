...
function updateCurrency(chainId) {
  if (chainId === 1 || chainId === 11155111) {
    ...
    Currency.ETHER = new Currency(18, 'LINEAETH', 'LINEA')
    ETHER = Currency.ETHER
    ...
    Currency.ETHER = new Currency(18, 'ETHER', 'BASE')
    ETHER = Currency.ETHER
  } else if (chainId === 168587773) {
    // Blast Smart Chain Mainnet
    Currency.ETHER = new Currency(18, 'ETHER', 'BLAST')
    ETHER = Currency.ETHER
  } else if (chainId === 1313161555) {
    // Aurora Smart Chain Mainnet
    Currency.ETHER = new Currency(18, 'ETHER', 'AURORA')
    ETHER = Currency.ETHER
  } else if (chainId === 534351) {
    // Scroll Smart Chain Mainnet
    Currency.ETHER = new Currency(18, 'ETHER', 'SCROLL')
    ETHER = Currency.ETHER
  } else if (chainId === 1287) {
    // Moonbase Smart Chain Mainnet
    Currency.ETHER = new Currency(18, 'DEV', 'MOONBASE')
    ETHER = Currency.ETHER
  }
}
...
const WETH =
  ...
  (_WETH[ChainId.BINANCETEST] = /*#__PURE__*/ new Token(
    ChainId.BINANCETEST,
  ...
  (_WETH[ChainId.AMOY] = /*#__PURE__*/ new Token(
    ChainId.AMOY,
  ...
  (_WETH[ChainId.AVALANCE] = /*#__PURE__*/ new Token(
    ChainId.AVALANCE,
  ...
  (_WETH[ChainId.LINEA] = /*#__PURE__*/ new Token(
    ChainId.LINEA,
  ...
  (_WETH[ChainId.CELO] = /*#__PURE__*/ new Token(
    ChainId.CELO,
  ...
  (_WETH[ChainId.AURORA] = /*#__PURE__*/ new Token(
    ChainId.AURORA,
  ...
  (_WETH[ChainId.SCROLL] = /*#__PURE__*/ new Token(
    ChainId.SCROLL,
    '0xC8481648F5Ff2Fe46027a4E5B49165A55DE106Fd',
    18,
    'WETH',
  ...
  (_WETH[ChainId.MOONBASE] = /*#__PURE__*/ new Token(
    ChainId.MOONBASE,
    '0xa1012EE0BEE96dcbC08267Fc35E6B06E64E4AC45',
    18,
    'WDEV',
...
const Pair = /*#__PURE__*/ (function () {
  function Pair(tokenAmountA, tokenAmountB, INIT_CODE_HASH, FACTORY_ADDRESS) {
    ...
    this.liquidityToken = new Token(
      ...
      Pair.getAddress(tokenAmounts[0].token, tokenAmounts[1].token, INIT_CODE_HASH, FACTORY_ADDRESS),
      18,
      'SWAP-LP',
      'Swap-LP-Token'
    )
...
export {
  ...
  ETHER,
  updateCurrency,
  // FACTORY_ADDRESS_P_MAINNET, //rishabh changes
  Fetcher,
  Fraction,
  // INIT_CODE_HASH,
