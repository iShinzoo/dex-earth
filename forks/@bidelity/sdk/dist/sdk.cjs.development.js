...
// const { FACTORY_ADDRESS } = require('./constants')
...
function updateCurrency(chainId) {
  if (chainId === 1 || chainId === 11155111) {
    ...
    // Amoy Smart Chain Mainnet
    Currency.ETHER = new Currency(18, 'MATIC', 'Amoy')
  } else if (chainId === 421614) {
    // Arbitrum Smart Chain Mainnet
    Currency.ETHER = new Currency(18, 'ARB', 'Arbitrum')
  } else if (chainId === 4002) {
    // Fantom Smart Chain Mainnet
    Currency.ETHER = new Currency(18, 'FTM', 'Fantom')
  } else if (chainId === 43113) {
    // Avalance Smart Chain Mainnet
    Currency.ETHER = new Currency(18, 'AVAX', 'Avalance')
  } else if (chainId === 11155420) {
    // Optimism Smart Chain Mainnet
    Currency.ETHER = new Currency(18, 'OPT', 'Optimism')
  } else if (chainId === 59141) {
    // Linea Smart Chain Mainnet
    Currency.ETHER = new Currency(18, 'LINEA', 'Linea')
  } else if (chainId === 44787) {
    // Celo Smart Chain Mainnet
    Currency.ETHER = new Currency(18, 'CELO', 'Celo')
  } else if (chainId === 84532) {
    // Base Smart Chain Mainnet
    Currency.ETHER = new Currency(18, 'BASE', 'Base')
  } else if (chainId === 168587773) {
    // Blast Smart Chain Mainnet
    Currency.ETHER = new Currency(18, 'BLAST', 'Blast')
  } else if (chainId === 1313161555) {
    // Aurora Smart Chain Mainnet
    Currency.ETHER = new Currency(18, 'AURORA', 'Aurora')
  } else if (chainId === 534351) {
    // Scroll Smart Chain Mainnet
    Currency.ETHER = new Currency(18, 'SCROLL', 'Scroll')
  } else if (chainId === 1287) {
    // Moonbase Smart Chain Mainnet
    Currency.ETHER = new Currency(18, 'MOONBASE', 'Moonbase')
  }
}
...
const WETH =
  ...
  (_WETH[exports.ChainId.BINANCETEST] = /*#__PURE__*/ new Token(
  ...
  (_WETH[exports.ChainId.AMOY] = /*#__PURE__*/ new Token(
  ...
  (_WETH[exports.ChainId.AVALANCE] = /*#__PURE__*/ new Token(
  ...
  (_WETH[exports.ChainId.LINEA] = /*#__PURE__*/ new Token(
  ...
  (_WETH[exports.ChainId.CELO] = /*#__PURE__*/ new Token(
  ...
  (_WETH[exports.ChainId.AURORA] = /*#__PURE__*/ new Token(
  ...
  (_WETH[exports.ChainId.SCROLL] = /*#__PURE__*/ new Token(
  ...
  (_WETH[exports.ChainId.MOONBASE] = /*#__PURE__*/ new Token(
...
const Pair = /*#__PURE__*/ (function () {
  function Pair(tokenAmountA, tokenAmountB, INIT_CODE_HASH, FACTORY_ADDRESS) {
    const tokenAmounts = tokenAmountA.token.sortsBefore(tokenAmountB.token) // does safety checks
      ? [tokenAmountA, tokenAmountB]
      : [tokenAmountB, tokenAmountA]
    this.liquidityToken = new Token(
      tokenAmounts[0].token.chainId,
      Pair.getAddress(tokenAmounts[0].token, tokenAmounts[1].token, INIT_CODE_HASH, FACTORY_ADDRESS), //RishabhChanged
      18,
      'SWAP-LP',
      'Swap-LP-Token'
    )
  ...
  //RishabhChanged
  Pair.getAddress = function getAddress(tokenA, tokenB, INIT_CODE_HASH, FACTORY_ADDRESS) {
...
const Trade = /*#__PURE__*/ (function () {
   ...
   * Note this does not consider aggregation, as routes.tsx are linear. It's possible a better route exists by splitting
   * the amount in among multiple routes.tsx.
...
const Fetcher = /*#__PURE__*/ (function () {
  ...
  Fetcher.fetchPairData = function fetchPairData(tokenA, tokenB, provider, INIT_CODE_HASH, FACTORY_ADDRESS) {
    try {
      ...
      !(tokenA.chainId === tokenB.chainId)
        ? 'development' !== 'production'
          ...
          : invariant(false)
        : void 0
      const address = Pair.getAddress(tokenA, tokenB, INIT_CODE_HASH, FACTORY_ADDRESS)
...
// exports.FACTORY_ADDRESS_P_MAINNET = FACTORY_ADDRESS_P_MAINNET //rishabhchanges
exports.Fetcher = Fetcher
exports.Fraction = Fraction
// exports.INIT_CODE_HASH = INIT_CODE_HASH //rishabhchanges
